...
/// Register the driver probe functions for all of the test device drivers in the system.
...
/// Activate and initialize the test devices discovered in the device tree. If any.
