...
/// Register the driver probe functions for all of the graphics device drivers in the system.
...
/// Activate and initialize the graphics devices discovered in the device tree. If any.
