...
/// Register the driver probe functions for all of the PLIC device drivers in the system.
...
/// Activate and initialize the PLIC devices discovered in the device tree. If any.
