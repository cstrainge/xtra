...
/// Register the driver probe functions for all of the MMIO device interfaces in the system.
...
/// Activate and initialize the MMIO devices discovered in the device tree. If any.
